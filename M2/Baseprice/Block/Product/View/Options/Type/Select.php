 ...
 */
namespace M2\Baseprice\Block\Product\View\Options\Type;
                ...
                $select = $this->getLayout()->createBlock(
                    \Magento\Framework\View\Element\Html\Select::class
                        ...
                        [
                            ...
                            'class' => $require . ' product-custom-option admin__control-select product-custom-option-select-'. str_replace(" ", "-", strtolower($_option->getTitle()))
                        ]
                        );
                    if ($_option->getType() == \Magento\Catalog\Api\Data\ProductCustomOptionInterface::OPTION_TYPE_DROP_DOWN) {
